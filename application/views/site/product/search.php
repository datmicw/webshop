	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
		...
		<div class="panel panel-info">
		  <div class="panel-heading">
		    <h3 class="panel-title">Result Search ( <?php echo $total; ?> Product)</h3>
		  </div>
	  			 ...
	  			 ?>
					<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 re-padding">
			  			<div class="product_item">
			  				...
			  				<?php	} ?>
							<p><span class="glyphicon glyphicon-eye-open" aria-hidden="true" title="View"></span> <?php echo $value->view; ?> <span class="glyphicon glyphicon-star-empty" aria-hidden="true" title="Quantity Purchased"><?php echo $value->buyed; ?></p>
